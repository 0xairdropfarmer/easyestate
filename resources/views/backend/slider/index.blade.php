            ...
            <tbody>
                <?php if(!empty($sliders)) { foreach ($sliders as $row) { ?>
                    <tr id="{{$row->id}}">
                        ...
                        <td>{{$row->title}}</td>
                        <td><?php if(!empty(get_property($row->product_id))) { $property = get_property($row->product_id);?> <a target="_blank" href="{{url('property/' . $property->id . '/' . clean($property->title) )}}"> {{$property->title}} </a> <?php } ?></td>
                        <td> 
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">
						...
						<select name="product_id" required id="product_id" class="form-control"> 
