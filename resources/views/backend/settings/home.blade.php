			 ...
			 <div class="col-md-6 col-sm-12">
                ...
                <div class="col-md-6 col-sm-12">
				 ...
				 <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        <label>Skype </label>
                        <input placeholder="Skype" name="skype"  value="<?php echo $setting->skype; ?>"  type="text" class="form-control">
                    </div>
                </div>
		  ...
		  <div id="other" class="tab-pane fade">
				...
				<div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <select id="theme_color"  name="theme_color" class="form-control">
                            ...
                            <option <?php if($setting->theme_color == "sea") { echo "selected"; } ?> value="sea">  Sea </option>
				...
				<div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <select id="theme_color"  name="theme_layout" class="form-control">
                            <option <?php if($setting->theme_layout == "layout-wide") { echo "selected"; } ?> value="layout-wide">  Wide  </option>
                            <option <?php if($setting->theme_layout == "layout-semiboxed") { echo "selected"; } ?> value="layout-semiboxed">  Semi Boxed </option>
                            <option <?php if($setting->theme_layout == "layout-boxed") { echo "selected"; } ?> value="layout-boxed">  Boxed </option>
                            <option <?php if($setting->theme_layout == "layout-boxed-margin") { echo "selected"; } ?> value="layout-boxed-margin">  Boxed Margin </option>
