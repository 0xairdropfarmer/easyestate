        ...
        <ul class="nav" id="side-menu">
           <!-- <li class="sidebar-search">
            ...
            <?php if (Auth::user()->AccessLevel == 0) { ?>
				...
				<li>
                    <a href="<?php echo url("admin/menus"); ?>"><i class="fa fa-user fa-fw"></i> Menu Management</a>
                </li>
				...
				<li>
                     <a href="#"><i class="fa fa-file-text-o fa-fw"></i> Assets <span class="fa arrow"></span></a>
			...
			<li>
                     <a href="#"><i class="fa fa-gear fa-fw"></i> Settings <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo url("admin/settings"); ?>"><i class="fa fa-gear fa-fw"></i> General </a>
                                </li>
								
								<li>
                                    <a  href="<?php echo url("translations/view/frontend"); ?>"><i class="fa fa-plus fa-fw"></i> Languages Editor </a>
                                </li>
								
								<li>
                                    <a  href="<?php echo url("admin/editor/html"); ?>"><i class="fa fa-plus fa-fw"></i> Html Editor </a>
                                </li>
				...
				<li>
                     <a href="#"><i class="fa fa-file-text-o fa-fw"></i> Pages <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo url("admin/pages"); ?>"><i class="fa fa-list fa-fw"></i> All Pages</a>
                                </li>
						 ...
						 <li>
							<a href="<?php echo url("admin/blog"); ?>"><i class="fa fa-list fa-fw"></i> Blog </a>
						</li>
