...
.checkboxes input[type="checkbox"]:checked + label::before, .range-slider .ui-widget-header, .tabs_services label.active, .tabs_services label:hover {
	...
	color:#fff;
                ...
                <!-- Slide -->           
                <div class="camera_wrap camera_white_skin" id="slide" style="margin-top: -1px;">
                    <!-- Item Slide -->  
                             ...
                             <div class="container"> 
                                <div class="row">
                                    <div class="col-md-7 col-md-offset-5">
										...
										<?php $property = get_property($slider->product_id);  if(!empty($property)) { ?>
                                        ...
                                        <ul class="animated fadeInRight delay3">
                                            ...
                                            <li class="price"><?php echo $setting->currency; ?><span>{{$property->price}}</span></li>
                                        </ul>
