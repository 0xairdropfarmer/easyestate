        ...
        <div class="form-group mamount"> 
            ...
            <div class="col-md-12">
                <div class="input-group"> 
                    ...
                    <span class="input-group-addon"><?php echo $setting->currency; ?></span>
                </div>
            </div>
        </div>
...
<script>
   ...
   function change() {
        ...
        $("#permonth").text("<?php echo $setting->currency; ?>" + permonth);
        $("#downpament_a").text("<?php echo $setting->currency; ?>" + downpayment.toFixed(2));
        $("#loanamount_total").text("<?php echo $setting->currency; ?>" + Number(loanamount_total).toFixed(2));
        $("#total_interest").text("<?php echo $setting->currency; ?>" + total_intrest.toFixed(2));
        $("#total_amount").text("<?php echo $setting->currency; ?>" + total_amount.toFixed(2));
		...
		for(var i=1; i <= Number(period) * 12; i++) { 
			...
			loanamount_left = loanamount_left - principle;
				$( "#tbody" ).append( "<tr style='background-color: #FBFCFF;border-top: dotted #DEEEFE 1px;'><td style='padding:5px'> "+ i +" </td><td> <?php echo $setting->currency; ?>"+ permonth  +" </td> <td><?php echo $setting->currency; ?>" + principle.toFixed(2) +" </td><td><?php echo $setting->currency; ?>" + intrest_l.toFixed(2)  + "</td>  <td> <?php echo $setting->currency; ?>"+ left_amount.toFixed(2) +" </td></tr>" );
		}
