...
class PropertyController extends Controller {
    ...
    public function save(Request $request) {
        ...
        if ($request->hasFile("mainfile")) {
            ...
            $path = "assets/images/uploads/$fileName.jpg";
            Image::make($path)->resize(
                    700, null, function ($constraint) {
        ...
        if ($id) {
			...
			if (!file_exists("assets/images/uploads/$g_id")) {
				$oldmask = umask(0);
				mkdir("assets/images/uploads/$g_id", 0777);
				umask($oldmask);
				DB::table("supporting_images")->where("g_id", $g_id)->update($data1);
    ...
    public function fileUpload() {
        ...
        if ($files[0]->isValid()) {
            ...
            $path = "assets/images/uploads/$id/$fileName.jpeg";
            Image::make($path)->resize(
                    700, null, function ($constraint) {
                $constraint->aspectRatio();
            }
